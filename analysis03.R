...
cluster_data <- read.csv("/Users/alexlawson/Desktop/Masters-Work/statistical-results/cluster-percentage-data.csv", stringsAsFactors = FALSE)
stats_input_final <- cluster_data
stats_input_final$MouseID <- factor(stats_input$MouseID)
stats_input_final$Cluster <- factor(stats_input$Cluster)
stats_input_final$Treatment <- factor(stats_input$Treatment)
stats_input_final$Sex <- factor(stats_input$Sex)
